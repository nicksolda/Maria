...
class Movie(db.Model):
    ...
    movie_image = db.Column(db.String(40), default='default_movie_image.png') ## δήλωση ονόματος εικόνας ταινίας (40 χαρακτήρες) με προεπιλεγμένο τίτλο:'default_movie_image.png', ΜΗ υποχρεωτικό πεδίο
